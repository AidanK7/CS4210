...
# SPECIFICATION: train, test and output the performance of 3 data models
...
for ds in dataSets:
    ...
    for i in range (10):
        ...
        for data in dbTest:
            ...
            prediction = clf.predict([testing_features])[0]
 
            #Compare the prediction with the true label (located at data[4]) of the test instance to start calculating the accuracy.
            #--> add your Python code here
            true_label = lenses_map[data[4]]
            if prediction == true_label:
                correct_predictions += 1

        accuracy.append(correct_predictions / len(dbTest))
